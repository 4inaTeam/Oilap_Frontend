...
class ComptableAddDialog extends StatefulWidget {
  const ComptableAddDialog({Key? key}) : super(key: key);

  @override
  State<ComptableAddDialog> createState() => _ComptableAddDialogState();
}

class _ComptableAddDialogState extends State<ComptableAddDialog> {
  ...
  Widget build(BuildContext context) {
    return BlocListener<ComptableBloc, ComptableState>(
      listener: (ctx, state) {
        if (state is ComptableAddSuccess && mounted) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Comptable ajouté avec succès')),
          );
        }
      ...
      child: AlertDialog(
        title: const Text('Ajouter un comptable'),
        content: SizedBox(
