  ...
  Future<http.Response> _withAuth(
    ...
    if (res.statusCode == 401) {
      ...
      if (newToken != null) {
        ...
        currentUserId = extractUserIdFromToken(newToken);
      } else {
        await _ts.clear();
        currentToken = null;
        currentRole = null;
  ...
  Future<String?> refreshAccessToken() async {
    try {
      ...
      if (res.statusCode == 200) {
        ...
        currentUserId = extractUserIdFromToken(newAccess);
...
/*STRIPE_PUBLISHABLE_KEY=pk_test_51R7CAPGaWkUiZSZpWP8sUXLyKXt2K96b4zzesdNxh7ZOdB1K1hkhxvTAd00e8oxPtuUiUOo1SnQnGwEQi0GczjKK006OvqX3Dq
